          ...
          <div className="section-container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="heading-display text-foreground animate-fade-up delay-100 opacity-0" style={{ animationFillMode: 'forwards' }}>
                Intelligent <span className="text-primary">AI Agents</span> & Business Automation
              </h1>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
                Scale your operations and boost efficiency with custom AI agents and automated workflows designed to handle repetitive tasks and complex logic.
              </p>
        ...
        <section className="section-padding bg-card">
          <div className="section-container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="heading-section mb-6">Our AI Solutions</h2>
                <div className="space-y-4">
                  {[
                    "Custom AI Chatbots & Customer Support Agents",
              ...
              <div className="bg-secondary/30 rounded-2xl p-8 border border-border/50">
                ...
                <p className="text-muted-foreground mb-6">
                  Dont get left behind in the AI revolution. Our automation experts will help you identify and implement high-impact AI opportunities.
                </p>
                <Button variant="outline" className="w-full">Explore AI Use Cases</Button>
              </div>
            </div>
          </div>
        </section>
