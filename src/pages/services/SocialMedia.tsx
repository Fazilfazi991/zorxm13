          ...
          <div className="section-container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="heading-display text-foreground animate-fade-up delay-100 opacity-0" style={{ animationFillMode: 'forwards' }}>
                Dominate the <span className="text-primary">Social Landscape</span>
              </h1>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-up delay-200 opacity-0" style={{ animationFillMode: 'forwards' }}>
                Grow your brand, engage your audience, and drive conversions across all major social platforms with our expert management and strategy.
              </p>
        ...
        <section className="section-padding bg-card">
          <div className="section-container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="heading-section mb-6">Our Social Media Expertise</h2>
                <div className="space-y-4">
                  {[
                    "Platform Strategy & Brand Positioning",
              ...
              <div className="bg-secondary/30 rounded-2xl p-8 border border-border/50">
                <h3 className="text-2xl font-bold mb-4">Build a Loyal community</h3>
                <p className="text-muted-foreground mb-6">
                  We don't just post content; we build relationships. Our strategies are designed to turn followers into brand advocates.
                </p>
                <Button variant="outline" className="w-full">View Our Packages</Button>
              </div>
            </div>
          </div>
        </section>
